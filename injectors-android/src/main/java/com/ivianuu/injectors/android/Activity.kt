...
private val INJECTORS_FINDER: (Activity) -> HasInjectors? = {
    it.application as? HasInjectors
}

/**
 * Injects the [instance]
 */
fun Injector.Companion.inject(instance: Activity) {
 ...
 * Injects [this]
 */
fun Activity.inject() = Injector.inject(this)